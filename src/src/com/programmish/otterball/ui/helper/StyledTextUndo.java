 ...
 */
public class StyledTextUndo implements KeyListener, ExtendedModifyListener {
     ...
     *            added
     */
    public StyledTextUndo(StyledText editor) {
    ...
    public void keyPressed(KeyEvent e) {
    	...
    	boolean isCtrl = (e.stateMask & this.metaKey) > 0;
